...
enum systemState { UNDEFINED_STATE = 7, UNSYNC_SWITCH_BEHAVIOUR, NOTHING_PRESSED, APPLY_PRESSED, RELEASE_PRESSED, VCC_ERROR, GND_ERROR, SHORT_VCC_C, SHORT_VCC_E, SHORT_GND_D, SHORT_GND_F, OPEN_RES_G, OPEN_RES_H};
